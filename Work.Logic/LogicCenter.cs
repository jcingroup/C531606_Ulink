...
namespace ProcCore.Business.LogicConect
{
    ...
    public class LogicCenter
    {
        ...
        protected C49A0_AlderEntities db0;
        protected TransactionScope tx;
        private const string DatabaseName = "C49A0_Alder";
        ...
        public static C49A0_AlderEntities getDB0
        {
            get
            {
                return new C49A0_AlderEntities(db0_connectionstring);
            }
        }
